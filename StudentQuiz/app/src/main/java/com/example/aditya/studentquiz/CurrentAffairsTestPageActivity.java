...
public class CurrentAffairsTestPageActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_affairs_test_page);
    ...
    public void showScore() {
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(CurrentAffairsTestPageActivity.this);
        alertDialog.setMessage("Your Score is"+score+"/15").setCancelable(false)
                .setPositiveButton("OK",new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        StudentPageActivity.subject="ca";
                        StudentPageActivity.count=count;
                        StudentPageActivity.flag=false;
                        finishAfterTransition();
                        startActivity(new Intent(CurrentAffairsTestPageActivity.this,ShowQuesAnsActivity.class));
                    }
                });
    ...
    public void submitScore() {
        ...
        databaseReference1.child("ca").setValue(score);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finishAfterTransition();
        startActivity(new Intent(CurrentAffairsTestPageActivity.this,StudentPageActivity.class));
    }
