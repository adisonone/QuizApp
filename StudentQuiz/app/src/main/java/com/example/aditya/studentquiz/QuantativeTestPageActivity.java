...
public class QuantativeTestPageActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quantative_test_page);
    ...
    public void showScore() {
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(QuantativeTestPageActivity.this);
        alertDialog.setMessage("Your Score is"+score+"/15").setCancelable(false)
                .setPositiveButton("OK",new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(QuantativeTestPageActivity.this,ShowQuesAnsActivity.class));
                    }
                });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finishAfterTransition();
        startActivity(new Intent(QuantativeTestPageActivity.this,StudentPageActivity.class));
    }
