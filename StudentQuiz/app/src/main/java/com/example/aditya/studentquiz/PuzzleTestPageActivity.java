...
public class PuzzleTestPageActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzle_test_page);
    ...
    public void showScore() {
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(PuzzleTestPageActivity.this);
        alertDialog.setMessage("Your Score is"+score+"/15").setCancelable(false)
                .setPositiveButton("OK",new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        StudentPageActivity.subject="puzzle-ques";
                        StudentPageActivity.count=count;
                        StudentPageActivity.flag=false;
                        finishAfterTransition();
                        startActivity(new Intent(PuzzleTestPageActivity.this,ShowQuesAnsActivity.class));
    ...
    public void submitScore() {
        ...
        databaseReference1.child("puzzle").setValue(score);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finishAfterTransition();
        startActivity(new Intent(PuzzleTestPageActivity.this,StudentPageActivity.class));
    }
