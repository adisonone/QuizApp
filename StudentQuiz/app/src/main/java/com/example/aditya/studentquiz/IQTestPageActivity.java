...
public class IQTestPageActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iq_test_page);
    ...
    public void showScore() {
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(IQTestPageActivity.this);
        alertDialog.setMessage("Your Score is"+score+"/15").setCancelable(false)
                .setPositiveButton("OK",new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        StudentPageActivity.subject="iq";
                        StudentPageActivity.count=count;
                        StudentPageActivity.flag=false;
                        finishAfterTransition();
                        startActivity(new Intent(IQTestPageActivity.this,ShowQuesAnsActivity.class));
    ...
    public void submitScore() {
        ...
        databaseReference1.child("iq").setValue(score);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finishAfterTransition();
        startActivity(new Intent(IQTestPageActivity.this,StudentPageActivity.class));
    }
